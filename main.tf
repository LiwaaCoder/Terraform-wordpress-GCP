...
provider "kubernetes" {
  host                   = "https://34.132.230.248"
  config_path = "~/.kube/config"
  config_context_cluster = "gke_delta-geode-378123_us-central1_autopilot-cluster-wideops-1"
...
resource "kubernetes_deployment" "wordpress" {
  metadata {
    name = "wordpress"
    namespace = "gke_delta-geode-378123_us-central1_autopilot-cluster-wideops-1"
  }
